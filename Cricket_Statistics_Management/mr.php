...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/pak/mr.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>MOHAMMAD RIZWAN</h3>
            <p>Pakistan</p>
        </div>
        <p>Mohammad Rizwan is a Pakistani international cricketer who is the current vice-captain of the Pakistan cricket team in T20I cricket and captains Pakistan Super League (PSL) franchise Multan Sultans.</p>
