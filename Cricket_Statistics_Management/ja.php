...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/eng/ja.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>JOFRA ARCHER</h3>
            <p>ENGLAND</p>
        </div>
        <p>Jofra Chioke Archer is a Barbadian-English cricketer who represents England in international cricket. He is a right-arm fast bowler.</p>
