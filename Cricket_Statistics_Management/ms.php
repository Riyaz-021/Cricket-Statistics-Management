...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/aus/mc.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>MITCHELL STARC</h3>
            <p>Australia</p>
        </div>
        <p>Mitchell Starc – a name that strikes fear into the hearts of contemporary batsmen. It is hard to fathom that the tall and skinny lad from Sydney, who was once an aspiring wicketkeeper in junior cricket, would one day become the most menacing sight for the world's best batsmen.</p>
