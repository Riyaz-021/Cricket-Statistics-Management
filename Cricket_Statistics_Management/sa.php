...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/pak/ss.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>SHAHEEN AFRIDI</h3>
            <p>Pakistan</p>
        </div>
        <p>Shaheen Shah Afridi is a Pakistani international cricketer who is the current captain of the Pakistan national cricket team in the T20I format. </p>
