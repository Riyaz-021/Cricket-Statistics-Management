...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/pak/fz.jpeg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>FAKHAR ZAMAN</h3>
            <p>Pakistani</p>
        </div>
        <p>Fakhar Zaman is a Pakistani international cricketer who plays for the Pakistan national cricket team.</p>
