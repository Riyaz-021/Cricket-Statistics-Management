...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/eng/jb.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>JOS BUTTLER</h3>
            <p>England</p>
        </div>
        <p>Jos Buttler is one of the world's best T20 batters and a star of the England limited-overs side. He has scored four centuries in the IPL, captained England to two T20 World Cups.</p>
