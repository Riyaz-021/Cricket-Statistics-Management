...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/pak/ba.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>BABAR AZAM</h3>
            <p>Pakistan</p>
        </div>
        <p>Mohammad Babar Azam is a Pakistani international cricketer and the former captain of the Pakistan national cricket team in all formats.</p>
