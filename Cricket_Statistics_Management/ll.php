...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/eng/ll.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>LIAM LIVINGSTONE</h3>
            <p>England</p>
        </div>
        <p>Liam Stephen Livingstone is an English cricketer who plays for Lancashire and England. Livingstone is a right-handed batter and spin bowler, capable of bowling both right-arm leg and off spin.</p>
