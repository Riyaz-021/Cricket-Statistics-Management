...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/eng/mw.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>MARK WOOD</h3>
            <p>ENGLAND</p>
        </div>
        <p>Mark Andrew Wood is an English cricketer who plays internationally for England in all formats. In domestic cricket, he represents Durham, and has played for Chennai Super Kings and for Lucknow Super Giants (in current season) in the Indian Premier League.</p>
