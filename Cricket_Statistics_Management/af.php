...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/aus/af.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>AARON FINCH</h3>
            <p>Australia</p>
        </div>
        <p>Aaron James Finch is an aggressive top-order batsman, who plays for Victoria. Known for his hard-hitting and ability to finish matches, Finch earned his spot in Australia's Under-19 team for the World Cup in 2006.</p>
