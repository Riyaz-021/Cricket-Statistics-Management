...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/aus/ss.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>STEVE SMITH</h3>
            <p>Australia</p>
        </div>
        <p>Arguably the best Test batter of his era and quite possibly of all time, Steven Smith's career redemption is a story for the ages.</p>
