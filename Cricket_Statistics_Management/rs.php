...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/ind/rs.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>ROHIT SHARMA</h3>
            <p>India</p>
        </div>
        <p>Rohit Gurunath Sharma is an Indian international cricketer who currently captains the India national cricket team across all formats. He is a right-handed batsman.Considered one of the best batsmen of his generation and one of the greatest opening batters of all time, Sharma is known for his timing, elegance, six-hitting abilities and leadership skills. </p>
