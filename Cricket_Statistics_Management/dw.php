...
<body class="bg-dark">
    ...
    <center>
        <div class="container-fluid">
            <img src="./statpage/aus/dw.jpg" style ="clip-path: circle(50% at 50% 50%);"/>
            <h3>DAVID WARNER</h3>
            <p>Australia</p>
        </div>
        <p>David Warner had one of the most memorable debuts in international cricket, when he was plucked from obscurity - without having played a single First-Class match - and made a stunning 89 off 43 balls in a T20l against South Africa. </p>
